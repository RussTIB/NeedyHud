...
Scheme
{
	Colors
	{
		...
		"G_ActiveWindow"			"238 151 237 255" // Active window bg color
		"G_InctiveWindow"			"238 151 237 255" // Inactive window bg color
		"G_TitleBg"					"239 207 239 255" // Title bg color
		"G_TitleText"				"77 33 203 255" // Title text color
		"G_Highlight"				"77 35 205 255" // Highlight color
		"G_ConsoleBg"				"204 228 252 255" // Console bg color
		"G_ListBg"					"204 228 252 255" // List bg color
		"G_Border"					"77 35 205 255" // Border color
		"G_Text"					"77 33 203 255" // Text color
		"G_HighlightText"			"204 228 252 255" // Highlight text color
		"G_SelectedText"			"77 35 205 255" // Selected text color
		"G_DisabledText"			"155 162 204 255" // Disabled text color
		"G_ButtonBg"				"204 228 252 255" // Button bg color
		"G_ButtonText"				"77 35 205 255" // Button text color
		"G_ButtonHoverBg"			"77 35 205 255" // Button hover bg color
		"G_ButtonHoverText"			"204 228 252 255" // Button hover text color
		"G_InputBg"					"144 243 225 255" // Input bg color
	    ...
	    "QuickListBGSelected"       "77 35 205 255" // Highlight color
	...
	BaseSettings
	{
		...
		Console.TextColor									"G_Text"
		Console.DevTextColor								"G_Text"
	}
	...
	Fonts
	{
		...
		AchievementItemTitle	[$WIN32]
		{
			...
			{
				"name"		"Arial" [!$OSX]
				"name"		"PixelMplus12 Regular Bold" [$OSX]
				"weight"		"1500"
				"tall"			"16" [!$OSX]
				"tall"			"18" [$OSX]
				"antialias"		"1"
